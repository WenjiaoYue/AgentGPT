  ...
  return (
    <MenuPrimitive>
      <div className="relative">
        <MenuPrimitive.Button className="bg-slate-13 flex h-8 items-center gap-1 rounded-lg bg-slate-1 p-2 font-bold shadow-depth-1 hover:bg-slate-3">
          <div>{icon}</div>
...
export const MenuItems = ({ buttonPosition, items, show }: MenuItemsProps) => {
  return (
    ...
    >
      <MenuPrimitive.Items
        className={clsx(
          "bg-slate-13 absolute right-0 z-20 max-h-48  w-fit min-w-full overflow-hidden rounded-xl shadow-xl",
