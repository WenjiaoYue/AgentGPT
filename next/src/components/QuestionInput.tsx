    ...
    <div className="relative flex flex-col">
      <div className="flex flex-grow flex-row items-center gap-1">
        <input
          ...
          name={props.name}
          id={props.name}
          className="placeholder:text-color-tertiary w-full rounded-full border-2 border-slate-6 bg-slate-1 p-4 text-slate-14 caret-purple-400 ring-0 transition-colors duration-300 selection:bg-purple-300 hover:border-purple-200 focus:border-purple-400 focus:outline-0 focus:ring-0  sm:leading-6"
