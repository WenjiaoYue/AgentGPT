...
const WindowButton = ({ ping, onClick, icon, text, border }: WindowButtonProps) => {
  return (
    <div
      className={clsx(
        "relative flex h-8 cursor-pointer items-center gap-2 rounded-lg bg-slate-1 p-2 font-mono text-sm font-bold text-slate-14 transition-all hover:bg-slate-3",
