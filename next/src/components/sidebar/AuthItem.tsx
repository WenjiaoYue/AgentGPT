...
const AuthItem: FC<{
  ...
  return (
    <div className="flex items-center justify-between">
      <div
        className={clsx(
          "flex flex-1 cursor-pointer items-center justify-start gap-3 rounded-md px-1.5 py-2 text-sm font-semibold text-slate-14 hover:bg-slate-5",
          classname
        )}
        onClick={(e) => {
      ...
      >
        ...
        {!user && (
          <h1 className="ml-2 flex h-6 w-6 flex-grow items-center gap-2 text-center text-slate-14">
            <FaSignInAlt />
            <p>Sign in</p>
          </h1>
        )}
